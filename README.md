...
Features involved are:
 1)RTL design with separate files for each pipeline stage 
...
1)Data forwarding from the EX/MEM and MEM/WB stages to reduce unnecessary stalls. 2)Detection of load-use hazards with automatic pipeline stalling. 
